	...
	<div id="bo_list" class="inner">
		...
		<script>
			 $(document).ready(function()
			 {
			  ...
			  function()
			  {
			   $($cl).toggleClass("bg_before bg_after");
			   $($view).slideToggle(1);
			...
			<tr>
				...
				<td class="td_date" style="text-align:center"><? if($is_admin) { ?><a href="<?php echo G5_URL; ?>/bbs/write.php?w=u&bo_table=<?=$bo_table?>&wr_id=<?=$list[$i]['wr_id'];?>">수정</a><? } ?><div id="click_<?php echo $list[$i]['wr_id'] ?>" class="click bg_before"></div></td>
			</tr>
