 <section class="sub_top_section">
	<div class="sub_bg11 sub1_tit sub_top">
		<div class="center text_center sub_top_bg">
			<p class="notes white_color fw_500 point_font">WOOSOO DENTAL CLINIC</p>
			<h2 class="sub_tit tit mt2 mb2 fw_500">더 가까이 다가가는 우수치과</h2>
		</div>
	</div>
</section>
<?php 

include_once(G5_PATH.'/sub1_nav.php');
...
<div class="row">
	...
	<article id="bo_v" style="width:<?php echo $width; ?>">
		...
		<div id="bo_v_top">
			...
			<ul class="bo_v_left">
				<?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="btn"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 수정</a></li><?php } ?>
				<?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" class="btn" onclick="del(this.href); return false;"><i class="fa fa-trash" aria-hidden="true"></i> 삭제</a></li><?php } ?>
				<?php if ($copy_href) { ?><li><a href="<?php echo $copy_href ?>" class="btn" onclick="board_move(this.href); return false;"><i class="fa fa-files-o" aria-hidden="true"></i> 복사</a></li><?php } ?>
				<?php if ($move_href) { ?><li><a href="<?php echo $move_href ?>" class="btn" onclick="board_move(this.href); return false;"><i class="fa fa-arrows-alt" aria-hidden="true"></i> 이동</a></li><?php } ?>
				<?php if ($search_href) { ?><li><a href="<?php echo $search_href ?>" class="btn"><i class="fa fa-search" aria-hidden="true"></i> 검색</a></li><?php } ?>
			</ul>

			<ul class="bo_v_com">
			   <li><a href="<?php echo $list_href ?>" class="btn"><i class="fa fa-list" aria-hidden="true"></i> 목록</a></li>
				<?php if ($reply_href) { ?><li><a href="<?php echo $reply_href ?>" class="btn"><i class="fa fa-reply" aria-hidden="true"></i> 답변</a></li><?php } ?>
				<?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> 글쓰기</a></li><?php } ?>
			</ul>
