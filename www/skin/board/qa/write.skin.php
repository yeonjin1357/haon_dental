...
<div id="qa_head">
    ...
    echo $option_hidden;
    ?>
	<div class="tbl_frm01 tbl_wrap" style="margin-top:7%">
        <table>
	...
	<div class="tbl_frm01 tbl_wrap" style="margin-top:4%">
		<table>
		<caption>문의내용</caption>
		<tbody>
        <?php if ($is_category) { ?>
        <tr>
            <th scope="row"><label for="ca_name">문의분류<strong class="sound_only">필수</strong></label></th>
            <td>
                <select class="frm_input" id="ca_name" name="ca_name" required>
        ...
        <tr>
            ...
            <td>		
				<div class="fileBox">
					...
					<input type="file" name="bf_file[]" id="uploadBtn" class="uploadBtn">
				</div>
    ...
    <div class="btn_confirm" style="margin-top:4%">
        <input type="submit" value="등록" id="btn_submit" class="btn_submit" accesskey="s">
