...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        ...
        <span class="sound_only">댓글</span><strong><a href="#bo_vc"> <i class="fas fa-comments"></i> <?php echo number_format($view['wr_comment']) ?>건</a></strong>
        <span class="sound_only">조회</span><strong><i class="fa fa-eye" aria-hidden="true"></i> <?php echo number_format($view['wr_hit']) ?>회</strong>
        <strong class="if_date"><span class="sound_only">작성일</span><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo date("m-d", strtotime($view['wr_datetime'])) ?></strong>
    ...
    <section id="bo_v_atc">
        ...
        if($v_img_count) {
            ...
            for ($i=0; $i<=count($view['file']); $i++) {
                ...
                if($i==0){
                    echo '<img src="'.$board_skin_url.'/img/arr.png" alt="" class="arr">';
                }
            }
