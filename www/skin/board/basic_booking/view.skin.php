...
if($board["bo_1"] == "1"){
    include_once($board_skin_path.'/view.skin.head.php');
    
    if( !$is_admin && $view['mb_id'] != $member[mb_id] && $view['wr_9'] != ""){ // 벌이뉨 승인관련
        alert('승인되지 않은 게시물입니다.');
    }
}
// add_stylesheet('css 구문', 출력순서); 숫자가 작을 수록 먼저 출력됨
add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/style.css">', 0);
add_javascript('<script src="'.$board_skin_url.'/js/tooltipsy.min.js"></script>', 101);
?>
    ...
    <div id="bo_v_top">
        ...
        <ul class="bo_v_left">
			...
			<?php if($is_admin && $board["bo_1"] == "1"){?>
				<?php if($view['wr_9'] == ""){?>
					<li class="btn_b04 btn reg-up" data-value="<?=$view['wr_id']?>" reg-cancel="1" style="cursor: pointer;"><i class="fa fa-hand-o-up" aria-hidden="true"></i> 승인됨</li>
				<?php }else if($is_admin){?>
					<li class="btn_admin btn reg-up" data-value="<?=$view['wr_id']?>" reg-cancel="0" style="cursor: pointer;"><i class="fa fa-hand-o-up" aria-hidden="true"></i> 미승인</li>					
				<?php }?>
			<?php }?>
			<!-- 벌이뉨 승인 관련 버튼 -->             
