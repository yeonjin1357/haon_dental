	...
	<div class="inner">
		...
		<article id="bo_v" style="width:<?php echo $width; ?>">
			...
			<div id="bo_v_top">
				...
				<ul class="bo_v_left">
					<?php if ($update_href) { ?><li><a href="<?php echo $update_href ?>" class="btn_b01 btn"><i class="fa fa-eraser" aria-hidden="true"></i> 수정</a></li><?php } ?>
					<?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" class="btn_b01 btn" onclick="del(this.href); return false;"><i class="fa fa-ban" aria-hidden="true"></i> 삭제</a></li><?php } ?>
