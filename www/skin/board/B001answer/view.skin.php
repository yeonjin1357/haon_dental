<?php
 include_once(G5_PATH.'/board_nav.php');
 ?>
<script>
	$(document).ready(function(){
		$('.sub-menu02').prev().html('치과소식');
	});
</script>
	...
	<div class="inner">
		...
		<article id="bo_v" style="width:<?php echo $width; ?>">
			...
			<section id="bo_v_info">
				<h2>페이지 정보</h2>
				<?php echo $view['name'] ?>
				<?php if ($view['wr_comment'] <= 0) { ?>
				<a href="#bo_vc" class="color-gray"><i class="oi oi-chat"></i> 답변을 준비중 입니다.</a>
				<?php } else if ($view['wr_comment'] > 0) { ?>　
				<a href="#bo_vc" class="color-gray"><i class="oi oi-chat"></i> <?php echo number_format($view['wr_comment']) ?> 개의 답변이 있습니다.</a>　
				<?php } ?>
