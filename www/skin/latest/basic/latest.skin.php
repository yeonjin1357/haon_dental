...
<div class="lat">
    ...
    <?php for ($i=0; $i<$list_count; $i++) {  ?>
        <li class="basic_li">
			...
			<li class="basic_li"> <?php echo cut_str($list[$i]['wr_content'],50);?></li>
    ...
    <a href="<?php echo get_pretty_url($bo_table); ?>" class="lt_more"><span class="sound_only"><?php echo $bo_subject ?></span><i class="fas fa-plus"></i></a>
