<style>
/*비급여 수가표*/
.payment_tit_wrap {width: 100%;max-width:1100px; margin:0 auto; padding-top:50px; padding-bottom:62px;}
.payment_tit {font-size:25px; color:#2f2725; width:290px; padding-bottom:7px; border-bottom:4px solid #1b1b1b;}
.payment_cont_wrap {width: 100%;max-width:1100px; margin:0 auto; padding-bottom:80px;overflow:hidden;}
.payment_tit_wrap p {font-size:18px; color:#2f2725; padding-top:20px; font-weight:700;}

.non_pay {float:left; width:50%;}
.non_payment {width:95%; font-size:16px;font-weight:400;}
.non_payment thead th {background:#f48124; padding:20px 0; color:#fff;font-weight:400;}
.non_payment tbody td {padding:10px 0; text-align:center; border-bottom:1px solid #dedede;}
